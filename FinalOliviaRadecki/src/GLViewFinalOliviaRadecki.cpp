...
GLViewFinalOliviaRadecki* GLViewFinalOliviaRadecki::New(const std::vector< std::string >& args)
{
	GLViewFinalOliviaRadecki* glv = new GLViewFinalOliviaRadecki(args);
...
GLViewFinalOliviaRadecki::GLViewFinalOliviaRadecki(const std::vector< std::string >& args) : GLView(args)
{
	//Initialize any member variables that need to be used inside of LoadMap() here.
	//Note: At this point, the Managers are not yet initialized. The Engine initialization
	//occurs immediately after this method returns (see GLViewFinalOliviaRadecki::New() for
	...
	//GLViewFinalOliviaRadecki::onCreate() is invoked after this module's LoadMap() is completed.
}


void GLViewFinalOliviaRadecki::onCreate()
{
	//GLViewFinalOliviaRadecki::onCreate() is invoked after this module's LoadMap() is completed.
...
GLViewFinalOliviaRadecki::~GLViewFinalOliviaRadecki()
{
	assets.saveAssets();
...
void GLViewFinalOliviaRadecki::updateWorld()
{
...
void GLViewFinalOliviaRadecki::moveCamera() {
...
void GLViewFinalOliviaRadecki::onResizeWindow(GLsizei width, GLsizei height)
{
	GLView::onResizeWindow(width, height); //call parent's resize method.
}

void GLViewFinalOliviaRadecki::onMouseDown(const SDL_MouseButtonEvent& e)
{
...
void GLViewFinalOliviaRadecki::onMouseUp(const SDL_MouseButtonEvent& e)
{
	GLView::onMouseUp(e);
}

void GLViewFinalOliviaRadecki::onMouseMove(const SDL_MouseMotionEvent& e)
{
	GLView::onMouseMove(e);
}


void GLViewFinalOliviaRadecki::onKeyDown(const SDL_KeyboardEvent& key)
{
...
void GLViewFinalOliviaRadecki::onKeyUp(const SDL_KeyboardEvent& key)
{
	GLView::onKeyUp(key);
	if (key.keysym.sym == SDLK_w)
	{
...
void Aftr::GLViewFinalOliviaRadecki::loadMap()
{
	...
	*/
	...
	createFinalOliviaRadeckiWayPoints();
}

void GLViewFinalOliviaRadecki::createFinalOliviaRadeckiWayPoints()
{
