...
namespace Aftr
{
	...
	/**
	   \class GLViewFinalOliviaRadecki
	   \author Scott Nykl
	...
	*/
	...
	class GLViewFinalOliviaRadecki : public GLView , protected AssetMenu , public NetMsgImportObject
	{
	public:
		static GLViewFinalOliviaRadecki* New(const std::vector< std::string >& outArgs);
		virtual ~GLViewFinalOliviaRadecki();
		virtual void updateWorld(); ///< Called once per frame
		virtual void loadMap(); ///< Called once at startup to build this module's scene
		virtual void createFinalOliviaRadeckiWayPoints();
	...
	protected:
		GLViewFinalOliviaRadecki(const std::vector< std::string >& args);
