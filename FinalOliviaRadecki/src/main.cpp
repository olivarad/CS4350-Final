...
#include <vector>
#include <memory>
#include "GLViewFinalOliviaRadecki.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewFinalOliviaRadecki > glView( Aftr::GLViewFinalOliviaRadecki::New( args ) );
